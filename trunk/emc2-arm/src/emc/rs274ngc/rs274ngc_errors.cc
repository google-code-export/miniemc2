...
/*  88 */ _("I word with no g2, g3, g87, or g43 to use it"), // check_other_codes
...
/*  94 */ _("K word with no g2, g3, g33, g33.1, g76, g87, or g43.1 to use it"), // check_other_codes
...
/* 192 */ _("X, y, z, a, b, c, u, v, and w words all missing with g38.2"), // convert_probe
...
/* 198 */ _("K word missing with g33/g33.1"), // check_other_codes
/* 199 */ _("F word used with a g33/g33.1"), // check_other_codes
