...
#define CONFIG_IPADDR		192.168.40.80
#define CONFIG_SERVERIP		192.168.40.8
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"bootargs=console=ttySAC0,115200n8 root=/dev/mtdblock3 rootfstype=jffs2\0" \
	"bootcmd_def=nand read.e 0x32000000 0x60000 0x500000; bootm 0x32000000\0" \
	...
	"update_kernel=tftpboot 0x32000000 uImage; nand erase 0x60000 0x500000; nand write.e 0x32000000 0x60000 0x500000\0" \
	"update_fs=tftpboot 0x32000000 rootfs.jffs2; nand erase 0x560000 0x2000000; nand write.e 0x32000000 0x560000 ${filesize}\0" \
	"update=run update_kernel;run update_fs;set bootcmd ${bootcmd_def};saveenv;run bootcmd\0" \
	""	
