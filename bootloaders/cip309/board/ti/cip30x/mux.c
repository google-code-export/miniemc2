...
static struct module_pin_mux uart1_pin_mux[] = {
	{OFFSET(uart1_rxd), (MODE(0) | PULLUDEN | RXACTIVE)},	/* UART1_RXD */
...
static struct module_pin_mux smscnet_pin_mux[] = {
	...
	{OFFSET(gpmc_a4), MODE(0) | PULLUP_EN},			/* NOR_A4 */
...
#endif
#ifdef CONFIG_SMC911X
{smscnet_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
#endif
#ifdef CONFIG_NOR
...
void enable_smscnet_pin_mux(void)
{
configure_module_pin_mux(smscnet_pin_mux);
}
