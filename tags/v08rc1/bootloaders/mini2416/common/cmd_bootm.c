...
int do_bootm (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	uint		unc_len = CFG_BOOTM_LEN;  //0x80000
...
#define LINUX_ZIMAGE_MAGIC	0x016f2818
	...
	if (*(ulong *)(addr + 9*4) == LINUX_ZIMAGE_MAGIC) {
		...
		addr = virt_to_phys(addr);  //translate 0xc0008000->0x30008000
		hdr = (image_header_t *)addr; //translate 0x30008000->base addresso f struct of Image_header_t
